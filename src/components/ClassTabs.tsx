...
export default function ClassTabs({ classId }: { classId: string }) {
  ...
  const tabs = [
    ...
    { href: `${base}/readwrite`, label: "ความสามารถและกิจกรรม", icon: "📝", color: "border-cyan-200 bg-cyan-50 text-cyan-700 hover:bg-cyan-100", activeColor: "border-cyan-500 bg-cyan-500 text-white shadow-cyan-200" },
