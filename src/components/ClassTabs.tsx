...
export default function ClassTabs({ classId }: { classId: string }) {
  ...
  const tabs = [
    ...
    { href: `${base}/learning-outcomes`, label: "ผลลัพธ์การเรียนรู้", icon: "📈", color: "border-blue-200 bg-blue-50 text-blue-700 hover:bg-blue-100", activeColor: "border-blue-500 bg-blue-500 text-white shadow-blue-200" },
